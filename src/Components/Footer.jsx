      ...
      <div className=" mx-auto  max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-justify">
            <img src={DrLocumLogo} alt="Dr. Locum Logo" className="w-32 mb-4" />
          ...
          {/* Connect With Us */}
          <div className="flex flex-col ml-20 items-center md:items-start text-center md:text-left">
          ...
          {/* Quick Links */}
          <div className="flex flex-col ml-25 items-center md:items-start text-center md:text-left">
